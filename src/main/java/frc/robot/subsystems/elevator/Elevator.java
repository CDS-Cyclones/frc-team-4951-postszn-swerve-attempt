...
public class Elevator extends SubsystemBase implements ElevatorIO {
    ...
    protected final SparkMax motorFollower = new SparkMax(Constants.elevatorMotor2Id, MotorType.kBrushless);
    ...
    private final ElevatorFeedforward feedforward = new ElevatorFeedforward(Constants.elevatorKs, Constants.elevatorKg, Constants.elevatorKv, Constants.elevatorKa);
...
public Elevator() {
  ...
  public void configMotors() {
    ...
    .allowedClosedLoopError(Constants.elevatorPositionTolerance);
    motorConfigFollower
    .apply(motorConfig)
 ...
 public void setSpeed(double speed) {
  ...
  // TODO: Implement Pivot so that i can actually use this. or else bad things happen and i burn another 2 neos.
